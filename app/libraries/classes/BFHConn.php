 ...
 * @version 0.91b
 *
 * Modified for Battlefield Hardline by Prophet of ADKGamers
 *
 */
...
class BFHConn
{
    ...
    function __construct($params = array()) {
        ...
        $this->_globalVars = array(
            "mapsFileXML" => app_path() . "/thirdparty/bfh/mapNames.xml",
            "playmodesFileXML" => app_path() . "/thirdparty/bfh/playModes.xml",
            "squadnamesFileXML" => app_path() . "/thirdparty/bfh/squadNames.xml",
            "teamnamesFileXML" => app_path() . "/thirdparty/bfh/teamNames.xml",
